...
function Show-Help {
    ...
    Write-Output ""
    Write-Output "  Create a Resource Group with tags:"
    Write-Output "    .\managerResourceGroup.ps1 -create -resourceGroupName 'DevRG' -location 'eastus' -tags 'env=dev','owner=admin'"
    Write-Output ""
